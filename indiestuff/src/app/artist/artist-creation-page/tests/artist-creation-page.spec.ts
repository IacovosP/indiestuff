...
describe('artist-creation-page', () => {
    ...
    describe('imageUpload', () => {
        let mockFetch;
        beforeEach(() => {
            mockFetch = spyOn(defaultHttpClient, 'fetch').and.callFake(() => Promise.resolve({}) as any);
        ...
        it('should call fetch with formData', () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('upload/image', requestInit.body, requestInit.method);
        });
    });

    describe('onFormSubmit', () => {
        beforeEach(() => {
            spyOn(defaultHttpClient, 'fetch').and.callFake(() => Promise.resolve());
        });
        ...
        it('should call fetch with album value', () => {
            ...
            artistCreationPage.onFormSubmit({ value: { title: 'newTitle' }, valid: true }, {} as Event);
