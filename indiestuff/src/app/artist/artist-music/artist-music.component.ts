...
export class ArtistMusicComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.artistMusic = new ArtistMusic({
      ...
      headerImageUrl: "https://crypticrock.com/wp-content/uploads/2020/02/the-slow-rush-slide.jpg",
      ...
      albums: [
        ...
        },
        {
          ...
          durationInSec: 11000,
          artistName: "SomeArtist",
          imageUrl: "https://centaur-wp.s3.eu-central-1.amazonaws.com/creativereview/prod/content/uploads/2020/02/1-Tame-Impala-TSR-%E2%80%93-Neil-Krug.jpg"
        },
        {
          name: "SomeAlbum",
          durationInSec: 12000,
